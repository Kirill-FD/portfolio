...
const skills = [
  ...
  { icon: Target, label: "Цифровые продукты", desc: "Создаю гайды, инструкции и шаблоны для реального применения" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              меняют качество работы. <br/>Мой подход — практичность и ясность: никаких
              <br />
